...
Claude Code applies this pattern with its tool search feature. The agent queries the tool search to discover relevant tools, then loads only those tools into the active context.
