...
```bash
curl -X GET "https://your-site.com/umbraco/ai/management/api/v1/analytics/usage-by-model?from=2024-01-01T00:00:00Z&to=2024-01-31T23:59:59Z" \
...
var response = await httpClient.GetAsync(
    $"/umbraco/ai/management/api/v1/analytics/usage-by-model?from={from:O}&to={to:O}");
